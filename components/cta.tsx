        ...
        <div className="bg-gradient-to-r from-transparent via-gray-800/50 py-12 md:py-20">
          <div className="mx-auto max-w-3xl text-center">
            <h2
              ...
              data-aos="fade-up"
            >
              Jangan biarkan bisnis Anda tertinggal di era digital. Mulai transformasi digital Anda bersama UKM Go Digital dan raih potensi pertumbuhan yang tak terbatas.
            </h2>
